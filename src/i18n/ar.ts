...
export const ar: Dictionary = {
  ...
  sources: {
    ...
    intro:
      'كل منحة في هذا الموقع قُرئت من صفحة تخصّ المؤسسة المانحة نفسها، أو الجهة الحكومية التي تموّلها. لا شيء مأخوذ من موقع وسيط، ولا رابط في أي بطاقة يقود إلى واحد — فأي رابط خارج نطاقات المؤسسات المسجّلة لا يدخل الفهرس أصلًا.',
    statOpen: 'مفتوحة الآن',
    statCountries: 'الدول',
    statListed: 'مؤسسات مدرجة',
    statChecked: 'مؤسسات فُحصت',
    crawler:
      'تعرّف أداة البحث عن نفسها بصراحة، وتلتزم بملف robots في كل موقع، وتنتظر بين الطلبات. ومع ذلك تحجبها بعض الجامعات، وهذا حقّها — وتظهر هنا على أنها تعذّر الوصول إليها بدل أن تُحذف بصمت.',
